        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            <?php echo $this->Html->link($committeesPerson['Person']['name'], array('controller' => 'people', 'action' => 'view', $committeesPerson['Person']['id'])); ?>
                        ...
                        <td class="actions" nowrap="nowrap">
                            <?php echo $this->Html->link(__('View'), array('action' => 'view', $committeesPerson['CommitteesPerson']['committee_id']), array('class' => 'btn btn-info')); ?>
                            <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $committeesPerson['CommitteesPerson']['committee_id']), array('class' => 'btn btn-warning')); ?>
                            <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $committeesPerson['CommitteesPerson']['committee_id']), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $committeesPerson['CommitteesPerson']['committee_id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
