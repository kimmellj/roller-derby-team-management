<div class="row-fluid">
	<div class="span3">
		<div class="well sidebar-nav">
			<ul class="nav nav-list">
				...
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PeopleTeam.person_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PeopleTeam.person_id'))); ?></li>
	...
	<div class="span9">
		...
		<?php echo $this->Form->create('PeopleTeam', array('inputDefaults' => Configure::read('inputDefaults')));?>
			<fieldset>
				<legend><?php echo __('Edit People Team'); ?></legend>
				<?php
