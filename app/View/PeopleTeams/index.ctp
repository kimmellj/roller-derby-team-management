        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            <?php echo $this->Html->link($peopleTeam['Team']['name'], array('controller' => 'teams', 'action' => 'view', $peopleTeam['Team']['id'])); ?>
                        ...
                        <td class="actions" nowrap="nowrap">
                            <?php echo $this->Html->link(__('View'), array('action' => 'view', $peopleTeam['PeopleTeam']['person_id']), array('class' => 'btn btn-info')); ?>
                            <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $peopleTeam['PeopleTeam']['person_id']), array('class' => 'btn btn-warning')); ?>
                            <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $peopleTeam['PeopleTeam']['person_id']), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $peopleTeam['PeopleTeam']['person_id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
