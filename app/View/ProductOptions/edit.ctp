	...
	<div class="span3 hidden-phone">
		<div class="well sidebar-nav">
			<ul class="nav nav-list">
				...
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductOption.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProductOption.id'))); ?></li>
